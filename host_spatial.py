...
class HostSpatialsCalc:
    ...
    def _check_input(self, roi, frame):
        ...
        # Take 10x10 depth pixels around point for depth averaging
        self.DELTA = 5
    ...
    def calc_spatials(self, depthData, roi, averaging_method=np.mean):
        ...
        centroid = (int((xmax + xmin) / 2), int((ymax + ymin) / 2))
        ...
        spatials = (averageDepth * math.tan(angle_x), -
                    averageDepth * math.tan(angle_y), averageDepth)
        # spatials = {
        #     'z': averageDepth,
